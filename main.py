...
from models import MVHGNN, PredictModule
...
def train_predict():
    ...
    plt.scatter(L, P, color='blue', alpha=0.5, label='Prediction ')
    ...
    plt.ylabel('Measured affinity', fontsize=22)
    plt.title('Scatter Plot of Predicted vs Measured Affinity', fontsize=22)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--edge_dropout_rate', type=float, default=0.2)  # --kiba 0.2
    ...
    parser.add_argument('--BEST_MODEL_PATH', type=str,
                        default=r'C:/Users/86176/Desktop/MVHGNN/bestmodel/best_model_new.pth')
    parser.add_argument('--BEST_Predictor_PATH', type=str,
                        default=r'C:/Users/86176/Desktop/MVHGNN/bestmodel/best_predictor_new.pth')
